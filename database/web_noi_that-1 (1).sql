...
(3311, 'Bàn ăn tròn Carter', NULL, 100, 7000000, NULL, 3, 31, 'Mặt kính cường lực dày\r\nHai bộ ống thép không gỉ được đặt cạnh nhau để cung cấp hỗ trợ lâu dài\r\nHoạt động tốt trong mọi không gian hiện đại hoặc đương đại', 0, 0, 0, '2020-09-16 12:19:50', '2020-09-16 12:19:50'),
(3312, 'Bàn ăn Reynosa', NULL, 100, 5000000, NULL, 3, 31, 'Có tám cổng sạc USB.\r\nGhế lên đến 6.', 0, 0, 0, '2020-09-16 12:19:50', '2020-09-16 12:19:50'),
(3321, 'Ghế ăn vải Niko', NULL, 100, 1000000, NULL, 3, 32, 'Chỗ ngồi nhồi bông rộng rãi làm cho nơi hoàn hảo để dành một bữa ăn thư giãn.\r\nCác polyester màu pastel, màu nước là một sự tương phản đáng yêu với các veneer Mindi màu óc chó.\r\nKhâu tinh tế và búi trung tâm đưa chiếc ghế này từ đơn giản đến phong cách.\r\nMột khung gỗ cao su bền cho sức mạnh và sự ổn định cho nhiều bữa ăn sắp tới.', 0, 0, 0, '2020-09-16 12:22:44', '2020-09-16 12:22:44'),
(3322, 'Ghế ăn Bolt', NULL, 100, 1000000, NULL, 3, 32, 'Được làm thủ công bằng gỗ thông nguyên khối, Ghế Bolt chuyển tiếp của chúng tôi cập nhật một hình bóng mộc mạc cổ điển với lớp sơn mài trắng sang trọng. Chi tiết chéo ở mặt sau làm tăng thêm sự thú vị và chắc chắn sẽ thu hút mọi ánh nhìn dù được đặt xung quanh bàn ăn hay được sử dụng làm ghế phụ trong phòng khách hoặc sảnh.', 0, 0, 0, '2020-09-16 12:22:44', '2020-09-16 12:22:44'),
(3331, 'Tủ Tenisha', NULL, 100, 13000000, NULL, 3, 33, 'Tận hưởng cảm giác nhẹ nhàng và thoáng mát mà chiếc tủ lấy cảm hứng từ đất nước này mang đến cho ngôi nhà của bạn.\r\nThể hiện sự sở hữu quý giá của bạn với đèn định vị LED tích hợp, cảm ứng.\r\nNỉ lót trong hai ngăn kéo để đựng đồ bạc của bạn hoặc các mảnh tinh tế khác.\r\nTay cầm bằng đồng cổ được chà xát bằng tay để cung cấp một kết thúc mộc mạc kỳ lạ.\r\nMàu trắng cổ điển và gỗ sồi chải hai tông màu thêm phong cách cho một loạt các phối màu.\r\nMái vòm chạm khắc dốc đẹp thêm phong cách trang trại cho phòng ăn của bạn.', 0, 0, 0, '2020-09-16 12:25:41', '2020-09-16 12:25:41'),
(3332, 'Tủ Curio', NULL, 100, 8000000, NULL, 3, 33, '4 kệ có thể điều chỉnh, có thể tháo rời; Đèn 50W có công tắc tắt / bật.\r\nKiểu dáng chuyển tiếp đẹp.\r\nSản xuất tại Canada của các vật liệu tốt nhất.\r\nXúc tác hoàn thiện để giúp đồ nội thất đẹp.\r\nBản lề đàn piano đầy đủ giúp cửa ổn định hơn và tránh bụi.\r\nLõm gỗ gụ để làm đẹp và củng cố tủ.\r\nMortise và mộng cửa xây dựng để làm cho nó kéo dài suốt đời.\r\nKết thúc phong cách sô cô la tuyệt đẹp và phần cứng niken chải.\r\nLắp ráp hoàn chỉnh; yêu cầu lắp đặt kính.', 0, 0, 0, '2020-09-16 12:25:41', '2020-09-16 12:25:41'),
(3341, 'Bộ ghế bar CorLiving', NULL, 100, 4000000, NULL, 3, 34, 'Kiểu dáng đẹp, khung chrome được làm nổi bật với da giả màu đen hiện đại.\r\nKhâu kim cương ở mặt sau hỗ trợ mang lại sự quan tâm trực quan tinh tế.\r\nThang máy khí cho phép điều chỉnh độ cao dễ dàng giữa 23,75 và 32 inch.\r\nChỗ để chân thuận tiện và tính năng xoay đảm bảo sự thoải mái lâu dài.\r\nKim loại bền và vật liệu đảm bảo những thanh phân này dễ dàng để làm sạch.\r\nGói này bao gồm hai phân thanh phù hợp.', 0, 0, 0, '2020-09-16 12:30:06', '2020-09-16 12:30:06'),
(3342, 'Bàn Bisk Bar', NULL, 100, 1000000, NULL, 3, 34, 'Thang máy chrome tuyệt đẹp điều chỉnh chiều cao bàn từ 26 \"đến 35,5\".\r\nMặt bàn tròn có bề mặt gỗ bóng mượt.\r\nThiết kế hợp lý có một dấu chân nhỏ để dễ dàng đặt.\r\nDễ dàng để làm sạch và lắp ráp.', 0, 0, 0, '2020-09-16 12:30:06', '2020-09-16 12:30:06'),
...
(1234, 3000000, 1512, 0, 'Ship nhanh nhanh', '2020-09-16 13:14:21', '2020-09-16 13:14:21'),
(2345, 40000000, 1512, 1, 'Ship lẹ lẹ còn đi ngủ', '2020-09-16 13:14:21', '2020-09-16 13:14:21'),
(3456, 6000000, 1512, 1, 'Không ship là cây vô đầu', '2020-09-16 13:17:58', '2020-09-16 13:17:58'),
(4567, 9000000, 1512, 1, 'Nhớ khuyến mãi cả người yêu nhé', '2020-09-16 13:20:13', '2020-09-16 13:20:13'),
(5678, 40000000, 1512, 1, 'Nhớ khuyến mãi thêm 1 bộ ', '2020-09-16 13:24:15', '2020-09-16 13:24:15');
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `ketnoidonhang` FOREIGN KEY (`transaction_id`) REFERENCES `transaction` (`id`),
  ADD CONSTRAINT `ketnoisanpham` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);

--
-- Các ràng buộc cho bảng `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `ketnoidanhmuc` FOREIGN KEY (`category`) REFERENCES `category` (`id`),
  ADD CONSTRAINT `ketnoiloai` FOREIGN KEY (`type`) REFERENCES `type` (`id`);

--
-- Các ràng buộc cho bảng `transaction`
--
ALTER TABLE `transaction`
  ADD CONSTRAINT `ketnoiusers` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Các ràng buộc cho bảng `type`
--
ALTER TABLE `type`
  ADD CONSTRAINT `ketnoicategory` FOREIGN KEY (`category`) REFERENCES `category` (`id`);
COMMIT;
