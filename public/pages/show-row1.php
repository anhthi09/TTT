    ...
    .then(data=>{
        ...
        var content=``;
            data.forEach(element =>{
                ...
                <div class="khung_san_pham col-4">
                                  <div class="Hinh_anhsp">
                                      <a href=" xem-hang.php?id= ${element.records[i].id}"><img src="/TTT/admin/modules/product/img_product/ ${element.records[i].avatar}"  alt="poto"></a>
                                  </div>
                                  <div class="ten_sp">
                                      <p> ${element.records[i].name}</p>
                                  </div>
                                  <div class="gia_sp">
                                  <p>   ${element.records[i].gia} </p>
                                  </div>
                                  </div>`;
                                });
